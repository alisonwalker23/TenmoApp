...
public class TenmoController {
    ...
    @RequestMapping(path = "/users/accounts/{accId}", method = RequestMethod.GET)
     public String getUsernameFromAccountId(@PathVariable int accId){
        return userDao.getUsernameFromAccountId(accId);
    }
